...
// colored shadow를 위해 추가한 부분
half3 CalculateBlinnPhongColoredShadow(Light light, InputData inputData, SurfaceData surfaceData, half3 shadowColor)
{
    half3 attenuatedLightColor = light.color * (light.distanceAttenuation * light.shadowAttenuation);
    attenuatedLightColor = lerp(shadowColor, attenuatedLightColor , light.shadowAttenuation);
...
half4 UniversalFragmentBlinnPhongColoredShadow(InputData inputData, SurfaceData surfaceData, half3 shadowColor)
{
    #if defined(DEBUG_DISPLAY)
    half4 debugColor;
...
#endif
    {
        lightingData.mainLightColor += CalculateBlinnPhongColoredShadow(mainLight, inputData, surfaceData, shadowColor);
    }
